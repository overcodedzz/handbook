...
![Architecture](/assets/images/docker/Untitled.png)
...
![Architecture2](/assets/images/docker/Untitled%201.png)
...
Cái thứ 2 là thường mình không clean các file không cần thiết (tools) sau khi build xong.
...
Phần này xứng đáng có một post riêng để bàn, vậy nên mình sẽ không đi sâu trong post này. Tìm hiểu chi tiết tại [đây](/technology/kubernetes)
...
## Contributors
- [minhdq99hp](minhdq99hp@gmail.com)
